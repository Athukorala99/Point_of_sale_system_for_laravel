...
<script>
    ...
    $('.total').on('DOMSubtreeModified', function() {
        ...
        // Update the balance, rounded to 2 decimal places
    });
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const quntity_price = document.getElementById('qunprice');
        const quanbalance = document.getElementById('quanbalance');

        quantity.addEventListener('input', function() {
            const add_quantity = parseFloat(quantity.value) || 0;
            const add_quantity_price = parseFloat(quntity_price.value) || 0;
            quanbalance.value = add_quantity * add_quantity_price;
        });
        quntity_price.addEventListener('input', function() {
            const add_quantity = parseFloat(quantity.value) || 0;
            const add_quantity_price = parseFloat(quntity_price.value) || 0;
            quanbalance.value = add_quantity * add_quantity_price;
        });
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const grntotal = document.getElementById('grn_total');
        const grndiscount = document.getElementById('dis_amount');
        const grnbalance = document.getElementById('balance');

        grndiscount.addEventListener('input', function() {
            const total = parseFloat(grntotal.value) || 0;
            const discount = parseFloat(grndiscount.value) || 0;
            grnbalance.value = total - discount;
        });
    });
</script>
@endsection