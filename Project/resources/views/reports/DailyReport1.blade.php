    ...
    <div class="detail">
        ...
        <table style="font-size: 9px; color:#666;">
            ...
            <tr>
                <td >ආරම්භක මුදල</td>
                <td>:</td>
                <td><span class="space"></span> <b>{{number_format(auth()->user()->payincash,2)}} </b></td>
            </tr>
            <tr>
                <td>ආදායම (Cash)</td>
                <td>:</td>
            ...
            <tr style="font-weight:bold;">
                <td>මුළු විකුණුම් මිල </td>
                <td>:</td>
                <td><span class="space"></span> {{number_format(auth()->user()->consumer_credit + auth()->user()->bank + auth()->user()->card + auth()->user()->cash - auth()->user()->payincash ,2)}}</td>
            </tr>

            <tr>
                <td>ලාච්චුවේ ඇති මුළු මුදල </td>
                <td>:</td>
                <td><span class="space"></span> <b>{{number_format(auth()->user()->cash,2)}}</b></td>
            </tr>
