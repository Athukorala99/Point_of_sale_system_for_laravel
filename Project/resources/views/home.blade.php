...
<div class="main">
  ...
  <div class="cardBox">
    ...
    <div class="card">
      <div>
        <div class="numbers">Rs: {{$todayTotalAmount}}</div>
    ...
    <div class="card">
      ...
      @endphp
      <div>
        <div class="numbers">Rs: {{ $profit->total_profits }}</div>
        <div class="cardName">
          {{ \Carbon\Carbon::create()->month($profit->month)->format('F') }} {{ $profit->year }} Profit
        </div>
      </div>
      @else
      <div>No profits for the current month.</div>
      @endif
    ...
    <div class="card">
      ...
      @endphp
      <div>
        <div class="numbers">Rs: {{ $earn->total_earnings }}</div>
        <div class="cardName">
          {{ \Carbon\Carbon::create()->month($earn->month)->format('F') }} {{ $earn->year }} Income
        </div>
      </div>
      @else
      <div>No earnings for the current month.</div>
      @endif
    ...
    <div class="card">
      <div>
        <div class="numbers">Rs: {{$card}}</div>
        <div class="cardName">Credit/Debit Payment</div>
    ...
    <div class="card">
      <div>
        <div class="numbers">Rs: {{$countconsumer_credit}}</div>
  ...
  <div class="details">
    <div class="recentOrders">
      ...
      <table>
        ...
        <tbody>
          ...
          @empty
          <tr>
            <td colspan="3">No products with low stock.</td>
          </tr>
          @endforelse
        </tbody>
      </table>
    ...
    <div class="recentCustomers">
      <div class="cardHeader">
        <h2>Alert Customers</h2>
      </div>
      <table>
        @foreach($customers as $customer)
        <tr>
          @if($customer->amount >= $customer->alert_amount )
          <td>
            <div class="imgBx"><img src="{{ asset('images/profile.jpg') }}" alt=""></div>
          </td>
          <td>
            <h4>{{$customer->name}} <br> <span>{{$customer->phone}}</span></h4>
          </td>
          @endif
        </tr>
        @endforeach
